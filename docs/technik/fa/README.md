...
<newSection title="Elektronisches Stabilitätsprogramm (ESP)">
...
<newSection title="Bremsassistent (BAS)">
...
<newSection title="Berganfahrhilfe">
...
<newSection title="Bergabfahrhilfe (HDC)">
...
<newSection title="Abstandsregeltempomat (ACC, Adaptive Cruise Control)">
...
<newSection title="Automatische Notbremssysteme (AEBS)">
...
<newSection title="Spurhalteassistenten (LKA, Lane Keeping Assistant)">
...
<newSection title="Spurverlassenswarner (LDW, Lane Departure Warning)">
...
<newSection title="Überholassistenten">
...
<newSection title="Multikollisionsbremse">
...
<newSection title="Fernlichtassistenten">
...
<newSection title="Speed Limiter">
...
<newSection title="Intelligent Speed Adaptation (ISA)">
...
<newSection title="Notbremslicht (Emergency stop signal)">
...
<newSection title="Erkennung und Notbremsung beim Rückwärtsfahren (Reversing detection)">

## Erkennung und Notbremsung beim Rückwärtsfahren (Reversing detection)

Bezeichnet ein System zur *Information des Fahrers über hinter dem Fahrzeug befindliche Personen und Objekte, dessen Hauptziel die Vermeidung von Zusammenstößen bei der Rückwärtsfahrt ist.*
...
<newSection title="Abbiegeassistent">
...
<newSection title="Fahrermüdigkeitserkennung und -aufmerksamkeitsüberwachung (Driver drowsiness and attention warning)">
...
<newSection title="Vorrichtung zum Einbau einer alkoholempfindlichen Wegfahrsperre (Alcohol interlock installation facilitation)">
